...
// EV parameter
extern int total_charging_pole, normal_charging_pole, fast_charging_pole, super_fast_charging_pole, EV_can_charge_amount;
extern float EV_MAX_SOC, EV_MIN_SOC;

// flag
extern bool SOC_change_flag, publicLoad_flag, EV_flag, EV_generate_result_flag;
